# MiSTercade V1-2025 Freeplay Mappings (No Menu Combo)

V1-2025 No-Menu Freeplay mapping database for the [MiSTercade](https://misteraddons.com/products/mistercade).
